<?php
$school_yearErr = $subject_idErr = $teacher_idErr = $week_dayErr = $notesErr = "";
$school_yearTr = $subject_idTr = $teacher_idTr = $week_dayTr = $notesTr = "";
...
if (isset($_POST['btnAdd'])) {
    ...
    if ($school_yearTr != "" && $subject_idTr != "" && $teacher_idTr != "" && $week_dayTr != "" && $notesTr != "") {
        header("Location: ../view/schedule_add_confirm.php?school_year=$school_yearTr&subject_id=$subject_idTr&teacher_id=$teacher_idTr&week_day=$week_dayTr&notes=$notesTr");
    }
}
