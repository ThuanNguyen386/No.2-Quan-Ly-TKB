    ...
    function subjectAddConfirm(){
        ...
        if($_SERVER['REQUEST_METHOD'] == 'POST') {
            if(isset($_POST['submit-confirm'])) {
                if(isset($_SESSION['subject_add_name']) && isset($_SESSION['subject_khoa']) 
                ...
                $_SESSION['check-subject-add-complete'] = $check_add;
                ...
                if($check_add){
                    ...
                    header('Location: ../../app/controller/SubjectComplete.php');
        }
            }
        }        
    }
